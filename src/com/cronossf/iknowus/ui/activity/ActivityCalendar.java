...
public class ActivityCalendar extends Activity {
	...
	public OnComplete onComplete = new OnComplete() {
		...
		public void onCompleted(List<Publicacion> lstPublications) {
			ActivityCalendar.this.lstPublications = lstPublications;
			lvPublications.setAdapter(new AdapterPublications(ActivityCalendar.this, lstPublications, false));
	...
	public void search(View view){
		OnSearch ons = new OnSearch() {			
			...
			public void onSearch(String filter) {
				...
				ActivityCalendar.this.filter = filter;
				lstPublications.clear();
				lvPublications.setAdapter(new AdapterPublications(ActivityCalendar.this, lstPublications, false));
				new TaskLoadLastPublications(ActivityCalendar.this, lstPublications, "calendario", filter, onComplete).execute();
			}
		};
