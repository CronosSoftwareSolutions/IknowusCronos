...
public class TaskSaveComment extends AsyncTask<String, String, String> {
	...
	public TaskSaveComment(Activity activity, String text, Long id_publicacion, Long id_usuario, OnComplete onComplete) {
	...
	protected void onPreExecute() {
		super.onPreExecute();
		dialog = new DialogLoading(activity, "Guardando tu comentario", "Se esta guardando tu comentario, esto podria demorar unos segundos...");
	...
	protected String doInBackground(String... params) {
		try {
			...
			if (Functions.isOnline(activity)) { 				
				publicacion = services.saveComment(text, id_usuario, id_publicacion);
